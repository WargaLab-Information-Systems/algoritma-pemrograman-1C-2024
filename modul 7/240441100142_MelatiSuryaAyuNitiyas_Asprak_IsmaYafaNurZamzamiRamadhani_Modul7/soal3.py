...
# fungsi ini menampilkan semua data siswa yang ada didalam daftar
def tampilkan_siswa(siswa):
    if len(siswa) == 0:
        print("Belum ada data siswa.\n")
        return
    print("Daftar Siswa:")
    # sebuah build in yang digunakan untuk menghitung itelasi dalam sebuah looping
...
# fungsi ini untuk mengubah data siswa yang sudah ada
...
# unutuk menghapus data siswa yang sudah ada
...
# untuk  mengelompokkan siswa berdasarkan kelas
...
# untuk mengelolah menu interaktif
def menu():
    siswa = []
    while True:
        print("\n=== Menu ===")
