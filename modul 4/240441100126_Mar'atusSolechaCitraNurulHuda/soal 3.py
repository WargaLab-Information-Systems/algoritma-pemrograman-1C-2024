...
for hari in range(1, 8):
    lembur_hari = int(input(f"Masukkan jam lembur untuk hari ke-{hari}: "))
    ...
    # Cek batas lembur 
    if lembur_hari > 8:
        print("Lembur melebihi batas, lembur hanya dihitung 8 jam")
        lembur_hari = 8
    ...
    # Cetak hasil harian
    print(f"Lembur hari ke-{hari}: {lembur_hari} jam, Gaji hari ke-{hari}: Rp{gaji_hari}")
...
print("Total gaji mingguan termasuk lembur: Rp", total_gaji_lembur + (gaji_harian * 7))