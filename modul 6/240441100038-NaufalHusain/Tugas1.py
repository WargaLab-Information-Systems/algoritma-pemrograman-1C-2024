# program menginput data karyawan
data_karyawan = []
...
def cari_karyawan(atribut, nilai):
    index = ["nip", "nama", "alamat", "departemen", "jabatan"].index(atribut) #mencari (posisi) pertama dari elemen tertentu dalam sebuah list.
...
def main():
    ...
    while True:
        ...
        lanjut = input("Apakah ingin mencari lagi? (ya/Tidak): ").lower() #data yg di inputkan biar jadi kecil semua
        if lanjut != "ya":
            break
