# Program Pendataan Karyawan sederhana
karyawan_list = []        #list kosong untuk menampung data karyawan
...
def tambah_karyawan():
    ...
    karyawan_list.append(karyawan) #program bisa menyimpan dan mengakses data karyawan secara berurutan dalam satu daftar.
