...
def input_data():
    while True:
        ...
        if any(data['NIP'] == nip for data in karyawan): # untuk mengecek kondisi,nip itu sudah di gunakan atau tidak
        ...
        karyawan.append(data_karyawan) #untuk menambah elemen baru
